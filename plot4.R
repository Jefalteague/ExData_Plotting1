...
plot(bound$Global_Active_Power ~ bound$posmake, pch = 20, cex = .1, xlab = "", xaxt = "n", ylab = "Global Active Power")
lines(bound$Global_Active_Power ~ bound$posmake, col = "black")
axis(1, at = sub_bound, labels = wk_cnvrt)

plot(bound$Voltage ~ bound$posmake, pch = 20, cex = .1, xlab = "datetime", xaxt = "n", ylab = "Voltage")
lines(bound$Voltage ~ bound$posmake, col = "black")
axis(1, at = sub_bound, labels = wk_cnvrt)

plot(bound$Sub_metering_1 ~ bound$posmake, pch = 20, cex = .1, xlab = "", xaxt = "n", ylab = "Energy sub metering")
...
legend("topright", inset=0, c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), bty = "n", lty = c(1, 1), lwd = c(1.0, 1.0), col = c("black","red","blue"), horiz=FALSE)
axis(1, at = sub_bound, labels = wk_cnvrt)

plot(bound$Global_Reactive_Power ~ bound$posmake, pch = 20, cex = .1, xlab = "", xaxt = "n", ylab = "Global_reactive_power")
lines(bound$Global_Reactive_Power ~ bound$posmake, col = "black")
axis(1, at = sub_bound, labels = wk_cnvrt)
